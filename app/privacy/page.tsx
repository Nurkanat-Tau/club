  ...
  return (
    <>
      ...
      <main className="space-y-4 px-4 pb-12 pt-6 leading-relaxed">
        ...
        <p>Имя, номер телефона (WhatsApp), PIN-код в зашифрованном виде, клубы, в которые вы вступили, встречи, на которые записались, отметки о посещении и ваши оценки встреч.</p>
        ...
        <h2 id="delete" className="pt-2 text-lg font-semibold">Как удалить данные или сменить PIN</h2>
        <ul className="list-disc space-y-1 pl-5">
          <li>Выйти из клуба — на странице клуба или в «Мои встречи».</li>
          <li>Сменить PIN — в «Мои встречи» → «Сменить PIN».</li>
          <li>Забыли PIN или хотите полностью удалить профиль — напишите администратору{contact ? "" : " через организатора вашего клуба"}. Мы удалим данные в течение 3 дней.</li>
        </ul>
        {contact && (
